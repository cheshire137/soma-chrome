...
function LastFM(options){
  ...
  var internalCall = function(params, callbacks, requestMethod){
    ...
    if(requestMethod == 'POST'){
      /* Remove previously created iframes */
      ...
      /* Attach onload handler after appending iframe to prevent double callback
       * in Chrome: http://stackoverflow.com/a/15880489/38743 */
